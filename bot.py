...
def _send_payload(target, payload):
    ...
    if typ == "text":
        ...
        for index, chunk in enumerate(chunks):
            ...
            # Escape Markdown metacharacters because the bot has a global Markdown mode.
            safe_chunk = re.sub(r'([_*`\[])', r'\\\1', chunk)
            sent_ids.append(bot.send_message(target, safe_chunk, reply_markup=markup).message_id)
    elif typ == "photo":
